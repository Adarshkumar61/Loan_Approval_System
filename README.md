...
Frontend UI Update
  ...
  <img src="![ui](loan_approval_ui.png)"
       alt="UI Effects Preview"
       style="width:100%; max-width:700px; border-radius:16px; margin:20px 0; box-shadow:0 15px 40px rgba(0,0,0,0.2);">
